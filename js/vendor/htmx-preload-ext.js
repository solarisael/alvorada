(function() {
   ...
   * This adds the "preload" extension to htmx. The extension will 
    ...
    *
    * Vendored 2026-07-02 from bigskysoftware/htmx-extensions (MIT), src/preload/preload.js.
    * `hx-ext="...preload..."` was already declared site-wide on <body> before this file
    * existed — the extension name was a silent no-op with nothing to load. This is that
    * missing file.
  */
